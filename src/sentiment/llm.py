...
def build_prompt(summary: str, status: str, comments: list[dict]) -> str:
    ...
    lines.append(
        ...
        "\n"
        "1. INTERACTION quality: Was the communication professional, responsive, and helpful?\n"
        "   - A polite explanation of why no action is needed is POSITIVE\n"
        "   - Negative means rude, dismissive tone, ignored complaints, or hostile exchange\n"
        "\n"
        "2. OUTCOME: Was the reported problem resolved or addressed?\n"
        "   - Positive = fixed, repaired, or adequately addressed\n"
        "   - Negative = ignored, unresolved, or explicitly declined\n"
        "   - Neutral = in progress, acknowledged but unclear resolution, or not applicable\n"
        "\n"
